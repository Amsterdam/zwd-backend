...
class CaseEvent(models.Model):
    ...
    TYPE_CASE_DOCUMENT = "CASE_DOCUMENT"
    TYPE_CASE_DOCUMENT_DELETED = "CASE_DOCUMENT_DELETED"
    TYPES = (
        (TYPE_CASE, TYPE_CASE),
        (TYPE_CASE_CLOSE, TYPE_CASE_CLOSE),
        (TYPE_GENERIC_TASK, TYPE_GENERIC_TASK),
        (TYPE_CASE_DOCUMENT, TYPE_CASE_DOCUMENT),
        (TYPE_CASE_DOCUMENT_DELETED, TYPE_CASE_DOCUMENT_DELETED),
    )
